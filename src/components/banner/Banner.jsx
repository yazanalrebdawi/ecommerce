...
const Banner = ({ data }) => {
  return (
    <div className="min-h-[550px] flex justify-center items-center py-12">
      <div className="container" style={{ backgroundColor: data.bgColor }}>
        {" "}
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 items-center text-white rounded-3xl">
          ...
          <div data-aos="zoom-in" className="h-full flex items-center">
            <img
              src={data.image}
              alt="pic"
              className="scale-125 w-[250px] md:w-[340px] mx-auto drop-shadow-2xl object-contain  "
            />
          </div>
          {/* third col */}
          <div className="flex flex-col justify-center gap-4 p-6 sm:p-8 ">
            ...
            <div data-aos="fade-up" data-aos-offset="0">
              <button
                className="bg-white text-white py-2 px-4 rounded "
